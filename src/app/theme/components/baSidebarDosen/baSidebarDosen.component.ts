...
import {BaSidebarServiceDosen} from './baSidebarDosen.service';

@Component({
  selector: 'ba-sidebar-dosen',
  encapsulation: ViewEncapsulation.None,
  styles: [require('./baSidebar.scss')],
  template: require('./baSidebar.html'),
  providers: [BaSidebarServiceDosen],
  directives: [BaSlimScroll]
})
export class BaSidebarDosen {
  ...
  constructor(private _elementRef:ElementRef,
              ...
              private _sidebarService:BaSidebarServiceDosen,
