...
import {BaSidebarServiceAdmin} from './baSidebarAdmin.service';

@Component({
  selector: 'ba-sidebar-admin',
  encapsulation: ViewEncapsulation.None,
  styles: [require('./baSidebar.scss')],
  template: require('./baSidebar.html'),
  providers: [BaSidebarServiceAdmin],
  directives: [BaSlimScroll]
})
export class BaSidebarAdmin {
  ...
  constructor(private _elementRef:ElementRef,
              ...
              private _sidebarService:BaSidebarServiceAdmin,
